...
with app.app_context():
    ...
    member1 = Member(id=3, first_name='Steva', last_name='Zikic', father_name='Jovan', profession='dip. Ekonomista', phone='+38763898554', email='steva.zikic22@live.com', address='Zike Zikica 21, Pirot', date_registered=date(2016, 2, 18), total_books_rented=15, date_expiration=date(2020, 9, 28), number_of_rented_books=1)
    ...
    extension1 = Extension(note='', price=10.0, date_performed=date(1999, 3, 23), date_extended=date(1999, 3, 23), price_id=3, member_id=24, price_details=price3, member=member3)
    extension2 = Extension(note='Učenik osnovne škole ne plaća članarinu', price=0.0, date_performed=date(2010, 1, 3), date_extended=date(2011, 1, 3), price_id=1, member_id=42, price_details=price1, member=member4)
    extension3 = Extension(note='', price=10.0, date_performed=date(2011, 5, 12), date_extended=date(2012, 5, 12), price_id=3, member_id=18, price_details=price3, member=member2)
    ...
    extension6 = Extension(note='Prva uplata', price=10.0, date_performed=date(2016, 2, 18), date_extended=date(2017, 2, 18), price_id=3, member_id=3, price_details=price3, member=member1)
    extension7 = Extension(note='Redovno produženje članarine', price=10.0, date_performed=date(2017, 9, 28), date_extended=date(2018, 9, 28), price_id=3, member_id=3, price_details=price3, member=member1)
    extension8 = Extension(note='', price=10.0, date_performed=date(2018, 9, 21), date_extended=date(2019, 9, 28), price_id=3, member_id=3, price_details=price3, member=member1)
    extension9 = Extension(note='Učenik osnovne škole ne plaća članarinu', price=0.0, date_performed=date(2018, 10, 7), date_extended=date(2019, 10, 7), price_id=1, member_id=42, price_details=price1, member=member4)
    extension10 = Extension(note='Produženje, cena redovna', price=10.0, date_performed=date(2019, 5, 20), date_extended=date(2020, 5, 20), price_id=3, member_id=24, price_details=price3, member=member3)
    ...
    extension12 = Extension(note='', price=10.0, date_performed=date(2019, 9, 24), date_extended=date(2020, 9, 28), price_id=3, member_id=3, price_details=price3, member=member1)
    extension13 = Extension(note='Član 659 ne plaća jer ovaj član plaća iznos akcije', price=14.00, date_performed=date(2019, 12, 30), date_extended=date(2020, 12, 30), price_id=4, member_id=103, price_details=price4, member=member6)
    extension14 = Extension(note='Ovaj član ne plaća članarinu, jer član 658 plaća iznos akcije', price=0.00, date_performed=date(2019, 12, 30), date_extended=date(2020, 12, 30), price_id=4, member_id=104, price_details=price4, member=member7)
    ...
    rental6 = Rental(date_performed=date(2016, 3, 19), date_deadline=date(2016, 4, 2), date_termination=date(2016, 4, 2), is_terminated=True, book_id=14, member_id=3, book=book14, member=member1)
    rental7 = Rental(date_performed=date(2016, 6, 30), date_deadline=date(2016, 7, 14), date_termination=date(2016, 7, 6), is_terminated=True, book_id=8, member_id=3, book=book8, member=member1)
    rental8 = Rental(date_performed=date(2018, 10, 7), date_deadline=date(2018, 10, 21), date_termination=date(2018, 10, 20), is_terminated=True, book_id=12, member_id=42, book=book12, member=member4)
    rental9 = Rental(date_performed=date(2018, 12, 11), date_deadline=date(2018, 12, 25), date_termination=date(2019, 1, 12), is_terminated=True, book_id=2, member_id=3, book=book2, member=member1)    
    rental10 = Rental(date_performed=date(2019, 4, 16), date_deadline=date(2019, 4, 30), date_termination=date(2019, 4, 29), is_terminated=True, book_id=10, member_id=42, book=book10, member=member4)
    rental11 = Rental(date_performed=date(2019, 10, 2), date_deadline=date(2019, 10, 16), date_termination=date(2019, 10, 15), is_terminated=True, book_id=7, member_id=76, book=book7, member=member5)                                                                                                                    
    rental12 = Rental(date_performed=date(2019, 12, 16), date_deadline=date(2019, 12, 30), date_termination=date(2020, 2, 10), is_terminated=True, book_id=10, member_id=24, book=book10, member=member3)    
    rental13 = Rental(date_performed=date(2019, 12, 30), date_deadline=date(2020, 1, 13), date_termination=date(2020, 1, 9), is_terminated=True, book_id=1, member_id=103, book=book11, member=member6)
    rental14 = Rental(date_performed=date(2020, 1, 13), date_deadline=date(2020, 1, 27), date_termination=date(2020, 1, 27), is_terminated=True, book_id=4, member_id=103, book=book4, member=member6)
    rental15 = Rental(date_performed=date(2020, 1, 20), date_deadline=date(2020, 2, 3), date_termination=date(2020, 1, 31), is_terminated=True, book_id=13, member_id=103, book=book13, member=member6)    
    rental16 = Rental(date_performed=date(2012, 3, 15), date_deadline=date(2012, 3, 29), date_termination=None, is_terminated=False, book_id=3, member_id=18, book=book3, member=member2)
    ...
    rental19 = Rental(date_performed=date(2020, 4, 9), date_deadline=date(2020, 4, 23), date_termination=None, is_terminated=False, book_id=11, member_id=3, book=book11, member=member1)
    rental20 = Rental(date_performed=date(2020, 4, 14), date_deadline=date(2020, 4, 28), date_termination=None, is_terminated=False, book_id=5, member_id=24, book=book5, member=member3)
    rental21 = Rental(date_performed=date(2020, 4, 15), date_deadline=date(2020, 4, 29), date_termination=None, is_terminated=False, book_id=1, member_id=103, book=book1, member=member6)
    rental22 = Rental(date_performed=date(2020, 4, 16), date_deadline=date(2020, 4, 30), date_termination=None, is_terminated=False, book_id=12, member_id=103, book=book12, member=member6)
    rental23 = Rental(date_performed=date(2020, 4, 18), date_deadline=date(2020, 5, 2), date_termination=None, is_terminated=False, book_id=14, member_id=76, book=book14, member=member5)
    rental24 = Rental(date_performed=date(2020, 4, 19), date_deadline=date(2020, 5, 3), date_termination=None, is_terminated=False, book_id=2, member_id=103, book=book2, member=member6)
